...
exports.MongoUser = mongoose.model('MongoUser', UserSchema);
...
exports.MongoLink = mongoose.model('MongoLink', LinkSchema);
...
exports.fetchLinks = function(req, res) {
  ...
  exports.MongoLink.find(function(err, links) {
    var linksArray = [];
...
exports.saveLink = function(req, res) {
  ...
  // MONGO
  var linkQuery = exports.MongoLink.where({ url: uri });
  linkQuery.findOne(function(err, link) {
    if (link) {
      ...
      util.getUrlTitle(uri, function(err, title) {
        ...
        var mongoLink = new exports.MongoLink({
          url: uri,
          title: title,
...
exports.loginUser = function(req, res) {
  ...
  // MONGO
  var userQuery = exports.MongoUser.where({ username: username });
...
exports.signupUser = function(req, res) {
  ...
  var password = req.body.password;
    ...
    userQuery.findOne(function (err, user) {
      if (!user) {
        var mongoUser = new exports.MongoUser({
          username: username,
          password: password,
        });
...
exports.navToLink = function(req, res) {
  ...
  var codeQuery = exports.MongoLink.where({ code: req.params[0] });
